...
var routes = [
    { path: '', redirectTo: "".concat(api_paths_1.ApiPaths.student), pathMatch: 'full' },
    { path: "".concat(api_paths_1.ApiPaths.student), component: pagina_student_component_1.PaginaStudentComponent },
    { path: "".concat(api_paths_1.ApiPaths.corso), component: pagina_corso_component_1.PaginaCorsoComponent },
];
